...
/**
 * This class defines the ClientService method, it is a collection of
 * CompanyRepository, CustomerRepository, and CouponRepository.
 * 
 * @returns a T/F boolean if the login was successful.
 */
@Service
