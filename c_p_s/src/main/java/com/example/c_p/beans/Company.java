...
/**
 * @param name     defines the name of the Company via String
 * @param email    defines the email of the Company via String
 ...
 *                 Coupons are allocated to the specific company
 */
